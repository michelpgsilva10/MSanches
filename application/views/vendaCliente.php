	...
	<div class="panel-body">
		<div class="panel panel-default">
			<div class="container-fluid">
				...
				<?php } ?>
				<br />
				<form class="form-inline" name="formV" method="post" role="form" action="<?php if(isset($desconto)){
																								 echo site_url("venda/buscaCliente/".$desconto."/".$total."/".$tipo."/".$idlista);
																							   }else{
																							   	  echo site_url("venda/buscaCliente/0/".$total."/".$tipo."/".$idlista);
																							   }?>">
					<div class="row">
								...
								<?php if(isset($cliente)){
									for($i=0;$i<count($cliente);$i++){?>
										<tr>
											...
											<td style="text-align: center;"> <a type="button" class="btn btn-info" href="<?php if(isset($desconto)){
																						                                         echo site_url("venda/selCliente/".$cliente[$i]['id_cliente']."/".$desconto."/".$total."/".$tipo."/".$idlista);
																						 									  }else{
																						 									  	echo site_url("venda/selCliente/".$cliente[$i]['id_cliente']."/0/".$total."/".$tipo."/".$idlista);
																						 									  }?>">Selecionar</a>
										</tr>
								<?php } } ?>
							</tbody>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3" align="center">
						<ul class="pager">
							<li>
								<a type="button" href="<?php if($tipo==0){ if(isset($desconto)){
																		    	echo site_url("venda/comum/".$desconto);
																			}else{
																				echo site_url("venda/comum/0");
																			}}else{echo site_url("venda/novoCom");}?>">Voltar</a>
							</li>
						</ul>
					</div>
				</div>
