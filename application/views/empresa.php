...
<div class="row" style=" text-align: center">
	<a href="#" class="button red">Transferencia</a>
	<br/>
	<a href="<?php echo site_url("empresa/balanco")?>" class="button orange">Balanço</a>
	<br/>
	<a href="<?php echo site_url("home")?>" class="button green">Voltar</a>
	<br/>
</div>